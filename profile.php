	...
	<div class="col-sm-8">
          ...
          "; ?>
           ...
           <?php 
            ...
            if(isset($_POST['submit'])){
              ...
              $update = "update users set user_cover='$u_cover.$random_number' where users_id='$user_id'";
          ...
          <?php 
            ...
            if(isset($_POST['update'])){
              ...
              $update = "update users set user_image='$u_image.$random_number' where users_id='$user_id'";
...
<div class="row">
	...
	<div class="col-sm-6">
		...
		<?php
			...
			$user = "select * from users where users_id='$user_id' AND posts='yes'"; 
			
			$run_user = $con->query($user); 
