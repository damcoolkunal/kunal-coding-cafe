...
$con = mysqli_connect("localhost","root","","social_network") or die("Connection was not established");
		...
		function insertPost(){
            ...
            if(strlen($upload_image) >= 1 && strlen($content) >= 1){
            	move_uploaded_file($image_tmp,"$upload_image.$random_number");
	              ...
	              $insert = "insert into post (users_id,post_content,upload_image,post_date) values ('$user_id','$content','$upload_image.$random_number',NOW())";
	              ...
	              $run = mysqli_query($con,$insert);
					...
					$update = "update users set post='yes' where users_id='$user_id'";
			...
			if($content==''){
	              ...
	              $insert = "insert into post (users_id,post_content,upload_image,post_date) values ('$user_id','No','$upload_image.$random_number',NOW())";
			...
			$insert = "insert into post (users_id,post_content,post_date) values ('$user_id','$content',NOW())";
	...
	while($row_posts=$run_posts->fetch_assoc()){

		$post_id = $row_posts['post_id'];
		$user_id = $row_posts['users_id'];
		$content = substr($row_posts['post_content'],0,40);
		$upload_image = $row_posts['upload_image'];
		$post_date = $row_posts['post_date'];

		//getting the user who has posted the thread
		$user = "select * from users where users_id='$user_id' AND post='yes'";
	...
	$row_posts=mysqli_fetch_array($run_posts);
		...
		if(isset($_POST['reply'])){
			...
			$insert = "insert into comments (post_id,users_id,comment,comment_author,date) values ('$post_id','$user_id','$comment','$user_com_name',NOW())";
	...
	global $con;
			...
			$get_posts = "select user_email from users where users_id='$u_id'";
			$run_user = mysqli_query($con,$get_posts);
			$row=mysqli_fetch_array($run_user);
	...
	while($row_user=mysqli_fetch_array($run_user)){
		...
		<div class='row'>
			...
			<img class='img-circle' src='$user_image' width='150px' height='140px' title='$username' style='float:left; margin:1px;'/>
			</a>
			</div><br><br>
			<div class='col-sm-6'>
			<a style='text-decoration: none;cursor: pointer;color: #3897f0;' href='user_profile.php?u_id=$user_id'>
