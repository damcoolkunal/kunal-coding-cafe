							    ...
							    <div class="modal-content">
							      ...
							      <div class="modal-body">
									...
									if(isset($_POST['sub'])){
										...
										$update = "update users set recovery_account='$bfn' where users_id='$user_id'";
...
<?php 
	if(isset($_POST['update'])){
		...
		$update = "update users set f_name='$f_name', l_name='$l_name',user_name='$u_name',describe_user='$describe_user',Relationship='$Relationship_status', user_pass='$u_pass',user_email='$u_email',user_country='$u_country',user_gender='$u_gender',user_birthday='$u_birthday' where users_id='$user_id'";
