...
<html>
<head>
	<title>Kunal Coding Cafe Login And Sign Up</title>
	<meta charset="utf-8">
...
<body>
	<div class="row">
		<div class="col-sm-12">
			<div class="well">
				<center><h1 style="color: white;"><strong>Kunal-Coding Cafe</strong></h1></center>
			</div>
		</div>
	</div>
		<div class="row">
			<div class="col-sm-6" style="left:0.5%;">
				<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQonOUGK2YQfJhTFBK9rr0pZU7A_874aZzu5tcYS0KzkwGzsM2z" class="img-rounded" title="Coding Cafe" width="650px" height="565px">
			...
			<div class="col-sm-6" style="left: 8%;">
				...
				<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTtXpUVnEEGZw5G8DZkz0Smuumz3MJGogg1fJQOcwZqQEX9WU91" class="img-rounded" title="Coding Cafe" width="80px" height="80px">
